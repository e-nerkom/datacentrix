            ...
            <div class="tab-content pb-100 px-3 px-sm-0" id="nav-tabContent">
                ...
                <div class="tab-pane fade show active container" id="nav-home" role="tabpanel"
                    ...
                    <div class="content-block">
                        ...
                        <p><strong>Certified Hardware Solutions</strong></p>
                        <p>Entrust has earned a broad set of certifications for nShield products. These certifications
                            help our customers to demonstrate compliance while also giving them the assurance that their
                            nShield HSMs meet stringent industry standards.</p>
                        <div style="margin-left: 20px;">
                            <p><strong>Security Compliance</strong></p>
                            <ul class="productdescription">
                                <li>FIPS 140-2 Level 2 and Level 3</li>
                                <li>USGv6 accreditation</li>
                                <li>eIDAS and Common Criteria EAL4 + AVA_VAN.5 and ALC_FLR.2 certification against EN
                                    419 221-5 Protection Profile, under the Dutch NSCIB scheme
                                    <ul class="productdescription">
                                        <li>Can form the basis of an EN 419 241-2 certified remote signing system for
                                            eIDAS.</li>
                                        <li>Compliant with BSI AIS 31 for true and deterministic random number
                                            generation</li>
                                    </ul>
                                </li>
                        ...
                        <p>nShield HSMs boast high elliptic curve cryptography (ECC) and RSA transaction rates. ECC, one
                        ...
                        <div style="width: 100%; overflow-x: auto;">
                            <table>
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan="7"><strong>ECC Prime Curve Signing Performance (tps) for NIST
                                                Recommended Key Lengths</strong></td>
                                    </tr>
                                    <tr>
                        ...
                        <br>
                        <p><strong>Note 1: Performance indicated requires ECDSA fast RNG feature activation available
                                free of charge on request from Entrust Support.</strong></p>
                        <p><strong>Wide Support for APIs, Cryptographic Algorithms and OSs</strong></p>
                        <div style="margin-left: 20px;">
                            <p><strong>Supported APIs</strong></p>
                            <ul class="productdescription">
                                <li>PKCS#11, OpenSSL, Java (JCE), Microsoft CAPI/ CNG and Web Services (requires Web
                                    Services Option Pack)</li>
                            </ul>
                            <p><strong>Supported Cryptographic Algorithms</strong></p>
                            <ul class="productdescription">
                                <li>Asymmetric public key algorithms: RSA, Diffie-Hellman, ECMQV, DSA, KCDSA, ECDSA,
                                    ECDH, Edwards (X25519, Ed25519ph)</li>
                                <li>Symmetric algorithms: AES, AES-GCM, ARIA, Camellia, CAST, RIPEMD160 HMAC, SEED,
                                    Triple DES</li>
                                <li>Hash/message digest: SHA-1, SHA-2 (224, 256, 384, 512 bit), HAS-160</li>
                                <li>Full Suite B implementation with fully licensed ECC including Brainpool and custom
                                    curves</li>
                                <li>Elliptic Curve Key Agreement (ECKA) available via Java API and nCore APIs</li>
                                <li>Elliptic Curve Integrated Encryption Scheme (ECIES) available via Java API, PKCS#11
                                    and nCore APIs</li>
                            </ul>
                            <p>nShield HSMs offers support for the majority of these cryptographic algorithms as part of
                                the standard feature set. For organizations wishing to use ECC or South Korean
                                algorithms, optional activation licenses are needed.</p>
                            <p><strong>Supported Platforms</strong></p>
                            <p>Windows and Linux operating systems including distributions from RedHat, SUSE and major
                                cloud service providers running as virtual machines or in containers.</p>
                        </div>
                        <p><strong>Reliability</strong></p>
                        <p>Calculated at 25°C operating temperature using Telcordia SR-332 “Reliability Prediction
                            Procedure for Electronic Equipment" MTBF Standard</p>
                        <ul class="productdescription">
                ...
                <div class="tab-pane fade container" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                    <div class="content-block">
                        ...
                        <p><strong>Performance Ratings and Options</strong></p>
                        <p>To meet the performance needs of your application, Entrust provides a variety of nShield
                            Connect models as shown in the Technical Specifications tab. You can select among the
                            performance models shown, and can also purchase in-field upgrades on XC models from lower
                            performance models to higher models.</p>
                        <p><strong>Client Licenses</strong></p>
                        <p>nShield Connect HSMs ship with three client licenses, each allowing a connection to an IP
                            address. Additional licenses are available for purchase. The maximum number of client
                            licenses supported varies by nShield Connect model as shown in the table below.</p>
                        ...
                        <p>Entrust offer a range of software option packs which can be used in conjunction with your
                            nShield HSMs. </p>
                        <p><a href="/digital-security/hsm/products/nshield-software/software-option-packs">Learn
                                More</a></p>
                        <p><strong>nShield Monitor</strong></p>
                        <p>nShield Monitor is a monitoring platform that provides 24x7 visibility into the status of
                            nShield HSMs. With this solution, security teams can efficiently inspect HSMs and find out
                            immediately if any potential security, configuration or utilization issue may compromise
                            their mission-critical infrastructure.</p>
                        <p><strong>Remote Administration Kits</strong></p>
                        <p>nShield Remote Administration lets operators manage distributed nShield HSMs—including adding
                            applications, upgrading firmware, checking status, re-booting and more—from their office
                            locations, reducing travel and saving money. Remote Administration Kits contain the hardware
                            and software needed to set up and use the tool. These kits are available for nShield Solo
                            and nShield Connect HSMs.</p>
                        <p><strong>CodeSafe</strong></p>
                        <p>CodeSafe is a powerful, secure environment that lets you execute applications within the
                            secure boundaries of nShield HSMs. Applications include cryptography and high value business
                            logic associated with banking, smart metering, authentication agents, digital signature
                            agents and custom encryption processes.&nbsp;CodeSafe is available with FIPS 140-2 Level 3
                            certified nShield Solo and nShield Connect HSMs.</p>
                        <p><strong>CipherTools</strong></p>
                        <p>The CipherTools is a set of tutorials, reference documentation, sample programs and
                            additional libraries. With this toolkit, developers can take full advantage of the advanced
                            integration capabilities of nShield HSMs. In addition to offering support for standard APIs,
                            the toolkit enables you to run custom applications with nShield HSMs. CipherTools Developer
                            Toolkit is included free of charge in the standard Security World software ISO/DVD.<span
                                style="font-size: 13px;"></span></p>
                        <p><strong>nToken</strong></p>
                        <p>Security teams that want to strongly authenticate their nShield Connect HSMs clients can use
                            nTokens PCIe cards to do hardware-based host identification and verification.</p>
                        <p><strong>Elliptic Curve Cryptography (ECC) Activation</strong></p>
                        <p>The ECC activation license enables EC-DH, EC-DSA and EC-MQV to be used on an nShield HSMs.
                        </p>
                        <p><strong>KCDSA Activation</strong></p>
                        <p>With the KCDSA activation license, you can use the Korean Certificate-based Digital Signature
                            Algorithm (KCSDA) as well as HAS-160, SEED and ARIA algorithms on an nShield HSMs.</p>
                        <p><strong>Slide Rails</strong></p>
                        <p>Entrust offers optional slide rails that let users mount nShield Connect in a 19" rack
                            without a shelf. Entrust recommends that customers use these slide rails exclusively as
                            parts from other manufacturers may not be compatible.</p>
                        <p><strong>Keyboard</strong></p>
                        <p>Many functions of nShield Connect HSMs can easily be executed using the touch wheel at the
                            front of the unit. Entrust offers an optional USB keyboard for even greater ease of use.</p>
                        <p><strong>Field Replaceable Parts</strong></p>
                        nShield Connectfeatures parts that operators can replace in the field, with minimal downtime.
                        These parts include dual, hot-swap power supplies and field-replaceable fan tray (requires
                        nShield Connect to be put into standby).
                        <p></p>
                        <div class="accordion-content-container">
                            <div></div>
                        </div>
                ...
                <div class="tab-pane fade container" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                    <div class="col-md-6">
                        <ul class="page-nav-vertical mb-50">
                            <li><a href="/assets/pdf/entrust-nshield-connect-ds.pdf" target="_BLANK">nShield Connect HSMs Datasheet</a></li>
                            ...
                            <li><a href="/assets/pdf/entrust-nshield-remote-administration-ds.pdf" target="_BLANK">nShield Remote Administration Datasheet</a></li>
                            <li><a href="/assets/pdf/entrust-nshield-monitor-ds.pdf" target="_BLANK">nShield Monitor Datasheet</a></li>
                            <li><a href="/assets/pdf/entrust-nshield-web-services-option-pack-ds.pdf" target="_BLANK">Web Services Option Pack Datasheett</a></li>
                        </ul>
                    </div>
